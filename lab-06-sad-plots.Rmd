...
```{r line-plot, fig.width = 10, fig.fullwidth = TRUE}
staff_long %>%
...
```{r faculty-trends, fig.width = 10, fig.fullwidth = TRUE}
staff_long %>%
  ggplot(aes(x = year, y = value, group = faculty_type, color = faculty_type)) +
  geom_line() +
  labs(title = "Faculty Trends", xlab = "", ylab = "") +
...
```{r clean-faculty-trends, fig.width = 10, fig.fullwidth = TRUE}
staff_long %>%
  ggplot(aes(x = year, y = value, group = faculty_type, color = faculty_type)) +
  geom_line() +
  labs(title = "Faculty Trends", xlab = "", ylab = "", subtitle = "Part-time Faculty Increase") +
  theme(legend.title = element_blank()) +
